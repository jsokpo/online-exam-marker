    ...
    public void setUp() 
{
  ...
  /**
	 * Test method for #
{
      @link com.exam.web.controller.ExamController#showExam(org.springframework.ui.Model)
}.
	 * @throws Exception 
	...
	public void testShowExam() throws Exception 
{
   ...
   .andExpect(model().attributeExists("exam"))
	...
	/**
	 * Test method for {@link com.exam.web.controller.ExamController

#login(org.springframework.ui.Model, 
com.exam.domain.Candidate, 
...
/**
	 * Test method for {
@link com.exam.web.controller.ExamController#callbackTimer(int, long)
}.
	 * @throws Exception 
	 */
	@Test
